...
class Comment extends amplify_core.Model {
  ...
  const Comment._internal({required this.id, title, body, owner, createdAt, updatedAt}): _title = title, _body = body, _owner = owner, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Comment({String? id, String? title, String? body, String? owner}) {
  ...
  Comment copyWith({String? title, String? body, String? owner}) {
    return Comment._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'body': _body, 'owner': _owner, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
